<?php
 ...
 const ec11_desc = "Cables/conduits are adequately supported and there is no obvious damage";
...
b) IP54 if there is no IP rating available for the enclosure ";
 ...
 const ec40_desc = "All equipment within the enclosure is suitably Ex e or Ex d or Ex m certified.";
 ...
 const ec54_desc = "For Zener barriers the impedance from the ISB earth point of connection to the main power system earth point is less than 1Ω";
